...
public class NomadicMerchantTask extends DelayedTask {
	...
	private final String TASK_NAME = "Nomadic Merchant Task";
	...
	private final String[] TEMPLATES = { "coal", "wood", "meat", "stone" };
	...
	protected void execute() {
		ServLogs.getServices().appendLog(EnumTpMessageSeverity.INFO, "Executing " + TASK_NAME + " for profile " + profile.getName());

		EmulatorManager.getInstance().searchTemplate(profile.getEmulatorNumber().toString(), EnumTemplates.GAME_HOME_FURNACE.getTemplate(), 600, 1150, 100, 100);
...
//			} else {
//				ServLogs.getServices().appendLog(EnumTpMessageSeverity.INFO, "Refresh button not found, finishing task.");
//				continueTask = false;
//				setRecurring(false);
//			}
//		}
...
//			DTOImageSearchResult result = ImageSearchUtil.buscarTemplate(resourcePath, square[0], square[1], width, height);
//			if (result.isFound()) {
//				return true;
//			}
//		}
...
//		EmulatorManager.captureScreenshot("0");
//		return ImageSearchUtil.buscarTemplate("/templates/refresh.png", REFRESH_BUTTON[0], REFRESH_BUTTON[1], 200, 70).isFound();
//	}

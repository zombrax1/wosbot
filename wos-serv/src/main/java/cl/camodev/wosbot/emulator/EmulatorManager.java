...
public class EmulatorManager {
	...
	public static void launchGame(String emulatorNumber) {
	...
	/**
	 * Captura la pantalla del emulador y guarda la imagen en el directorio de
	 * ejecución (user.dir) dentro de una carpeta "temp". Se crea el directorio en
	 * caso de no existir.
	 *
	 * @param emulatorNumber Número o identificador del emulador (puede usarse para
	 *                       personalizar la ruta si es necesario)
	 * @return true si la operación se completó correctamente, false en caso de
	 *         error.
	 */
	public static boolean captureScreenshot(String emulatorNumber) {
		...
		// dispositivo
		ProcessBuilder pbCapture = new ProcessBuilder(MUMU_PATH, "adb", "-v", "0", "shell", "screencap", "-p",
				"/sdcard/foto.png");

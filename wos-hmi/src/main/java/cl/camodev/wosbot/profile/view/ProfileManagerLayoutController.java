...
//					private final Button btnSave = new Button();
...

					{
						...
						btnLoad.setTooltip(new javafx.scene.control.Tooltip("Insert tasks to the selected profile"));
						btnLoad.setText("Insert Tasks"); // More descriptive than just an icon
